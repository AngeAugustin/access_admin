...
export default function PolitiqueParents() {
  return (
    <div className="container" style={{
      ...
      <h1 style={{
        ...
        Politique de Confidentialité – Parents Access Parents
      </h1>
      ...
      <p>
        Access Educateurs est une application gérée par SMS EXPERTISES. Elle permet aux parents béninois de trouver et sélectionner des éducateurs pour un accompagnement pédagogique personnalisé de leurs enfants.
      </p>

      <h2 style={{ color: "#005eab", marginTop: "1.5rem" }}>2. Données collectées</h2>
      <p>
        Nous collectons vos noms, prénoms, adresses, numéro de téléphone, email, informations sur vos enfants et vos besoins pédagogiques.
      </p>

      <h2 style={{ color: "#005eab", marginTop: "1.5rem" }}>3. Finalités</h2>
      <p>
        Vos données servent à créer votre compte, faciliter la mise en relation avec les éducateurs, gérer les séances et paiements, et assurer le suivi pédagogique.
      </p>
